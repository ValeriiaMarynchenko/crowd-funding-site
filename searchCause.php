...
<h2 class="fluid showAreaH2 headingStyle">Be a Part of Better Society</h2>
 <article class="fluid gallery">
   ...
   $cat = $_POST['cat'];
   $loc = $_POST['loc'];
$sql5 = "select post_picture, post_title, post_id from post where post_category='$cat' or post_location='$loc' "; 
...
$Numrow = mysqli_num_rows($result2);
   ...
   <a href="postDisplay.php?post_id=<?PHP echo $row2[2] ?>"> <img src="<?PHP echo $row2[0]; ?>" alt="placeholder"  height="300px" width="350px"/> 
